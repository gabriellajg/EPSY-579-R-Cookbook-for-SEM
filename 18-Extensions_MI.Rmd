...
```{r}
MIMICloading <- sem(srSyntaxMIMICLoading, 
                 data = affectData, 
                 fixed.x=FALSE,
                 estimator = 'MLR') 
...
```{r}
MIMICintercept <- sem(srSyntaxMIMICInt, 
                       data = affectData,
                       fixed.x=FALSE,
                       estimator = 'MLR') 
```
