...
```{r}
mod1_fit <- sem(mod1, data = cfaData, std.lv = TRUE, fixed.x=FALSE)
...
```{r}
mod2_1_fit <- sem(mod2_1, data = cfaData, std.lv = TRUE, fixed.x=FALSE)
...
```{r}
mod2_2_fit <- sem(mod2_2, data = cfaData, std.lv = TRUE, fixed.x=FALSE)
...
```{r}
mod3_fit <- sem(mod3, data = cfaData, std.lv = TRUE, fixed.x = FALSE)
